...
public:
	...
	ISteamUser* GetISteamUser_s(void* hSteamUser, void* hSteamPipe, const char* pchVersion)
	{
		typedef ISteamUser* (__stdcall* func)(void*, void*, const char*);
		return Utils::GetVFunc<func>(this, 5)(hSteamUser, hSteamPipe, pchVersion);
	}

	ISteamGameCoordinator* GetISteamGenericInterface_s(void* hSteamUser, void* hSteamPipe, const char* pchVersion)
	{
		typedef ISteamGameCoordinator* (__stdcall* func)(void*, void*, const char*);
		return Utils::GetVFunc<func>(this, 12)(hSteamUser, hSteamPipe, pchVersion);
	}
};
#endif