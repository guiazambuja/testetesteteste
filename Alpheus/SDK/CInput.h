...
public:
	...
	inline CVerifiedUserCmd* GetVerifiedUserCmd(int sequence_number);
	inline CUserCmd* GetUserCmd(int nSlot, int sequence_number);
	inline CUserCmd* GetUserCmd_S(int sequence_number);

};
CUserCmd* CInput::GetUserCmd_S(int sequence_number)
{
	using OriginalFn = CUserCmd * (__thiscall*)(void*, int, int);
	return  Utils::GetVFunc <OriginalFn>(this, 8)(this, 0, sequence_number);
}
...
public:
	...
	const char* ButtonCodeToString(ButtonCode_t ButtonCode) {
		...
		return Utils::GetVFunc<OriginalFn>(this, 40)(this, ButtonCode);
	}
};
