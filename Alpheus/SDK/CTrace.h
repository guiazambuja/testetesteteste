...
{
public:
	int GetPointContents(const Vector& vecAbsPosition, int contentsMask = MASK_ALL, C_BaseEntity** ppEntity = nullptr)
	{
		typedef int(__thiscall * fnGetPointContents)(void*, const Vector&, int, C_BaseEntity * *);
		return Utils::GetVFunc< fnGetPointContents >(this, 0)(this, vecAbsPosition, contentsMask, ppEntity);
	}
	...
	void ClipRayToEntity(const Ray_t& ray, unsigned int fMask, IHandleEntity* pEnt, trace_t* pTrace)
	{
		...
		Utils::GetVFunc< fnClipRayToEntity >(this, 3)(this, ray, fMask, pEnt, pTrace);
	}

	void TraceRay(const Ray_t& ray, unsigned int fMask, ITraceFilter* pTraceFilter, trace_t* pTrace)
	{
		typedef void(__thiscall * fnTraceRay)(void*, const Ray_t&, unsigned int, ITraceFilter*, trace_t*);
		Utils::GetVFunc< fnTraceRay >(this, 5)(this, ray, fMask, pTraceFilter, pTrace);
	}
};
IEngineTrace* pTrace;
...
public:
	...
	surfacedata_t* GetSurfaceData(int surfaceDataIndex)
	{
		...
		return Utils::GetVFunc<fnGetSurfaceData>(this, 5)(this, surfaceDataIndex);
	}
};