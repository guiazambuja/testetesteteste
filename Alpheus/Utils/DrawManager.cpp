...
void DrawManager::InitDeviceObjects(LPDIRECT3DDEVICE9 pDevice)
{
	...
	// Create new fonts
	//g_Fonts.pFontTahoma8 = std::make_unique<CD3DFont>(L"Square Sans Serif 7", 7.5, FW_NORMAL); //Cambria
	//g_Fonts.pFontTahoma10 = std::make_unique<CD3DFont>(L"Square Sans Serif 7", 8, FW_MEDIUM);
